# Generated by Django 4.2.3 on 2023-09-17 06:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Administrator', 'Administrator'), ('Company', 'Company'), ('Store Owner', 'Store Owner'), ('Store Manager', 'Store Manager')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_products', models.CharField(choices=[('Food', 'Food'), ('Hausehold', 'Hausehold')], max_length=20)),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
